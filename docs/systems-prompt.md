...
"Show me the org structure for a Ministry of Education."
...
---------------------
       ...
       |               |                    |
+--------------+  +-------------+    +------------------+
| Perm Sec     |  | Chief ICT   |    | Chief Curriculum |
|              |  | Officer     |    | Officer          |
+--------------+  +-------------+    +------------------+
...
"Create a wireframe of a chatbot interface with sidebar."

Output:
+----------------------------------------------------------+
| GEA AI Assistant                             [Settings]  |
+----------------------------------------------------------+
| Sidebar              | Chat Window                        |
|----------------------|------------------------------------|
| - Home               |  Assistant: Hello!                 |
| - Docs               |  User: Show wireframe              |
| - Analytics          |                                    |
| - Settings           |  [Input........................]   |
|                      |  [Send] [Clear]                    |
+----------------------|------------------------------------+
